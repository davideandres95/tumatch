...
sqlite3 var/flaskr-instance/project.db < securities.sql
sqlite3 var/flaskr-instance/project.db < users.sql
sqlite3 var/flaskr-instance/project.db < orders.sql
```
